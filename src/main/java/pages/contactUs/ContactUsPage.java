...
public class ContactUsPage extends BasePage {
    ...
    private final By nameInput = By.xpath("//input[@id='field_qh4icy581b9279ff34a9b3997a']");
    private final By emailInput= By.xpath("//input[@id='field_29yf4d514daf790a3168d9ecf7']");
    private final By subjectInput = By.xpath("//input[@id='field_e6lis6304bcba9ed089bc4a76c']");
    private final By commentIInput = By.xpath("//textarea[@id='field_9jv0r14048f6919408069a9bcb']");
