...
public class BasePage {
    ...
    private final By mainLogoButton = By.xpath("//a[@class='flRJt5BUsuG']");
    private final By headerMenuOpen = By.xpath("//button[@class='tr7mR_F1 js-modal-btn']");
    private final By languageMenuOpen = By.xpath("(//a[@class='IRgWDKL IZvykPmy0 js-header-drop-btn '])[4]");
    ...
    public BasePage headerButtonClick (int numButton) {
        By headerButton = By.xpath("(//a[@class='IRgWDKL '])[" + numButton + "]");
        driver.findElement(headerButton).click();
        return this;
    }

    public BasePage headerMenuOpen () {
        By headerButton = By.xpath("(//a[@class='IRgWDKL '])[2]");
    ...
    public BasePage footerButtonClick (int numButton) {
        By footerButton = By.xpath("(//a[@class='H0eu'])[" + numButton + "]");
