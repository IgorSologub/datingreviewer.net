...
public class BlogPage extends BasePage {
    ...
    private final By sliderBlock = By.xpath("(//div[@class='D8SbYJ'])[8]");
    private final By scrollToSlider = By.xpath("(//h2[@class='P3-0FiRjZqLB'])[11]");
    ...
    public Boolean inputErrorVisibleCheck () {
        boolean errorsCheck = driver.findElements(By.xpath("//*[@class='Tev2PqoEu error']")).size() == 3;
        if (!errorsCheck) {
            waitOneSeconds();
            submitButtonClick();
            waitTwoSeconds();
